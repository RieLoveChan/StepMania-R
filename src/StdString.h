 ...
 */
template <typename CT> inline CStdStr<CT> operator+(const CStdStr<CT> &str1, const CStdStr<CT> &str2) {
 ...
 * @return the longer string.
 */
template <typename CT> inline CStdStr<CT> operator+(const CStdStr<CT> &str, CT t) {
 ...
 * @return the longer string.
 */
template <typename CT> inline CStdStr<CT> operator+(const CStdStr<CT> &str, PCSTR pA) {
 ...
 * @return the longer string.
 */
template <typename CT> inline CStdStr<CT> operator+(PCSTR pA, const CStdStr<CT> &str) {
