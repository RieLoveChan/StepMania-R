...
if(WIN32)
  ...
  include("${SM_CMAKE_DIR}/SetupFfmpegWin32.cmake")

  find_library(LIB_SWSCALE
               NAMES "swscale"
               PATHS "${SM_FFMPEG_W32_DIR}/${SM_WIN32_ARCH}"
               NO_DEFAULT_PATH)
  ...
  foreach(dll ${SM_FFMPEG_WIN32_DLLS})
    ...
    file(COPY "${SM_FFMPEG_W32_DIR}/${SM_WIN32_ARCH}/${dll}" DESTINATION "${SM_PROGRAM_DIR}/")
  endforeach()
elseif(MACOSX)
